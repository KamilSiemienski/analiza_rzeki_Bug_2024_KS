...
map.getView().fit([640903.794777, 516573.251218, 647524.851240, 521052.793985], map.getSize());
...
var Title = new ol.control.Control({
    element: (() => {
        ...
        titleElement.innerHTML = '<h2 class="project-title">Analiza zmian koryta rzeki Bug w latach 1940 - 2024</h2>';
        return titleElement;
    })(),
    ...
    element: (() => {
        ...
        if (26 > 240) {
            ...
            window.showAbstract = function() {
                ...
                linkElement.innerHTML = 'Cwiczenia - SIP<br />Autor - KS';
            }
